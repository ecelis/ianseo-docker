 ...
 * Estende Obj_Rank
 */
	class Obj_Rank_Abs_50_calc extends Obj_Rank_Abs
	{
	/**
	 * calculate().
	 ...
	 */
		public function calculate() {
			...
			$q="SELECT
				...
				INNER JOIN Qualifications ON IndId=QuId
				left join (select max(RrPartSourceRank) as RrQualified, RrPartEvent from RoundRobinParticipants where RrPartTournament={$this->tournament} and RrPartTeam=0 and RrPartSourceLevel=0 group by RrPartEvent) RoundRobin on RrPartEvent=EvCode and EvElimType=5
				WHERE
