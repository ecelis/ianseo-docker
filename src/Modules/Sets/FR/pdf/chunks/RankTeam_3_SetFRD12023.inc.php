			...
			if(count($section['items'])) {
				...
				foreach($section['items'] as $item) {
					...
					if($NeedTitle) {
						...
						$pdf->Cell(50, 5, $section['meta']['fields']['countryName'], 1, 0, 'C', 1);
						$pdf->Cell(10, 5, $section['meta']['fields']['qualScore'], 1, 0, 'C', 1);
						$pdf->Cell(20, 5, $section['meta']['fields']['qualGolds'], 1, 0, 'C', 1);
						$pdf->Cell(20, 5, $section['meta']['fields']['qualXnine'], 1, 0, 'C', 1);
					...
					$pdf->Cell(38, 4*$NumComponenti, $item['countryName'] . ($item['subteam']<=1 ? '' : ' (' . $item['subteam'] .')'), 'TB', 0, 'L', 0);

					$pdf->SetFont($pdf->FontFix,'',8);
					$pdf->Cell(10, 4*$NumComponenti,  number_format($item['qualScore'],0,$PdfData->NumberDecimalSeparator,$PdfData->NumberThousandsSeparator), 1, 0, 'R', 0);
					$pdf->Cell(20, 4*$NumComponenti,  number_format($item['qualGolds'],0,$PdfData->NumberDecimalSeparator,$PdfData->NumberThousandsSeparator), 1, 0, 'R', 0);
					$pdf->Cell(20, 4*$NumComponenti,  number_format($item['qualXnine'],0,$PdfData->NumberDecimalSeparator,$PdfData->NumberThousandsSeparator), 1, 0, 'R', 0);
					$pdf->SetFont($pdf->FontStd,'',8);
