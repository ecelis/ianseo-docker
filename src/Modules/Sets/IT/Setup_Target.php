	...
	case 3:
        switch($SubRule) {
            case '1':
				...
				CreateDistanceNew($TourId, $TourType, 'COS_', array(array('50m-1',50), array('50m-2',50)));
				CreateDistanceNew($TourId, $TourType, 'COJ_', array(array('50m-1',50), array('50m-2',50)));
				CreateDistanceNew($TourId, $TourType, 'COA_', array(array('50m-1',50), array('50m-2',50)));
				CreateDistanceNew($TourId, $TourType, 'COM_', array(array('50m-1',50), array('50m-2',50)));
				CreateDistanceNew($TourId, $TourType, 'COR_', array(array('40m-1',40), array('40m-2',40)));
				CreateDistanceNew($TourId, $TourType, 'COG_', array(array('25m-1',25), array('25m-2',25)));
    ...
    case 37:
        switch($SubRule) {
            case '1':
				...
				CreateDistanceNew($TourId, $TourType, 'COS_', array(array('50m-1',50), array('50m-2',50), array('50m-3',50), array('50m-4',50)));
				CreateDistanceNew($TourId, $TourType, 'COJ_', array(array('50m-1',50), array('50m-2',50), array('50m-3',50), array('50m-4',50)));
				CreateDistanceNew($TourId, $TourType, 'COA_', array(array('50m-1',50), array('50m-2',50), array('50m-3',50), array('50m-4',50)));
				CreateDistanceNew($TourId, $TourType, 'COM_', array(array('50m-1',50), array('50m-2',50), array('50m-3',50), array('50m-4',50)));
				CreateDistanceNew($TourId, $TourType, 'COR_', array(array('40m-1',40), array('40m-2',40), array('40m-3',40), array('40m-4',40)));
				CreateDistanceNew($TourId, $TourType, 'COG_', array(array('25m-1',25), array('25m-2',25), array('25m-3',25), array('25m-4',25)));
    ...
    case 39:
		switch($SubRule) {
			case '1':
				...
				CreateDistanceNew($TourId, $TourType, 'COS_', array(array('50m-1',50)));
...
switch($TourType) {
	...
	case 3:
		...
		CreateTargetFace($TourId, $i++, 'Compound', 'REG-^CO[^R|^G]', '1',  TGT_OUT_5_big10, 80, TGT_OUT_5_big10, 80);
		CreateTargetFace($TourId, $i  , 'CO R/G', 'REG-^CO[R|G]', '1', TGT_IND_1_small10, 122, TGT_IND_1_small10, 122);
		TargetFaceGoldsXnines($TourId, $i++, '10', '9', 'L', 'J');
		CreateTargetFace($TourId, $i++, 'W1', 'REG-^W1', '1',  TGT_OUT_FULL, 80, TGT_OUT_FULL, 80);
		CreateTargetFace($TourId, $i++, 'VI', 'REG-^V', '1',  TGT_OUT_FULL, 80, TGT_OUT_FULL, 80);
		break;
    case 37:
        CreateTargetFace($TourId, $i++, 'Default', '%', '1', TGT_OUT_FULL, 122, TGT_OUT_FULL, 122, TGT_OUT_FULL, 122, TGT_OUT_FULL, 122);
        CreateTargetFace($TourId, $i++, 'Compound', 'REG-^CO[^R|^G]', '1',  TGT_OUT_5_big10, 80, TGT_OUT_5_big10, 80,  TGT_OUT_5_big10, 80, TGT_OUT_5_big10, 80);
		CreateTargetFace($TourId, $i  , 'CO R/G', 'REG-^CO[R|G]', '1',  TGT_IND_1_small10, 122, TGT_IND_1_small10, 122,  TGT_IND_1_small10, 122, TGT_IND_1_small10, 122);
		TargetFaceGoldsXnines($TourId, $i++, '10', '9', 'L', 'J');
		CreateTargetFace($TourId, $i++, 'W1', 'REG-^W1', '1',  TGT_OUT_FULL, 80, TGT_OUT_FULL, 80, TGT_OUT_FULL, 122, TGT_OUT_FULL, 122);
        CreateTargetFace($TourId, $i++, 'VI', 'REG-^V', '1',  TGT_OUT_FULL, 80, TGT_OUT_FULL, 80,  TGT_OUT_FULL, 80, TGT_OUT_FULL, 80);
        break;
    case 39:
