...
switch($TourType) {
    case 1:
        ...
        CreateDistanceNew($TourId, $TourType, 'R60',  array(array('70m',70), array('60m',60), array('50m',50), array('30m',30)));
        ...
        CreateDistanceNew($TourId, $TourType, 'C60',  array(array('70m',70), array('60m',60), array('50m',50), array('30m',30)));
        ...
        CreateDistanceNew($TourId, $TourType, 'RO60',  array(array('70m',70), array('60m',60), array('50m',50), array('30m',30)));
        ...
        CreateDistanceNew($TourId, $TourType, 'CO60',  array(array('70m',70), array('60m',60), array('50m',50), array('30m',30)));
    ...
    case 2:
        ...
        CreateDistanceNew($TourId, $TourType, 'R60', array(array('70m',70), array('60m',60), array('50m',50), array('30m',30), array('70m',70), array('60m',60), array('50m',50), array('30m',30)));
        ...
        CreateDistanceNew($TourId, $TourType, 'C60',  array(array('70m',70), array('60m',60), array('50m',50), array('30m',30), array('70m',70), array('60m',60), array('50m',50), array('30m',30)));
        ...
        CreateDistanceNew($TourId, $TourType, 'RO60', array(array('70m',70), array('60m',60), array('50m',50), array('30m',30), array('70m',70), array('60m',60), array('50m',50), array('30m',30)));
        ...
        CreateDistanceNew($TourId, $TourType, 'CO60',  array(array('70m',70), array('60m',60), array('50m',50), array('30m',30), array('70m',70), array('60m',60), array('50m',50), array('30m',30)));
...
switch($TourType) {
	...
	case 3:
	    if ($SubRule==1) {
            ...
            CreateTargetFace($TourId, 3, '~DefaultCO', 'REG-^COU18|^COU21|^CO60|^CO[M|W]$', '1', TGT_OUT_5_big10, 80, TGT_OUT_5_big10, 80);
            CreateTargetFace($TourId, 4, '~Default', 'REG-^W1U18|^W1U21|^W160|^CU15|^COU15|^W1[M|W]$', '1', TGT_OUT_FULL, 80, TGT_OUT_FULL, 80);
        } else {
	...
	case 6:
        if($SubRule==1) {
            CreateTargetFace($TourId, 1, '~Default', 'REG-^RU18|^RU21|^R60|^R[M|W]$|^ROU18|^ROU21|^RO60|^RO[M|W]$', '1', TGT_IND_6_big10, 40, TGT_IND_6_big10, 40);
            CreateTargetFace($TourId, 2, '~DefaultCO', 'REG-^CU18|^CU21|^C60|^C[M|W]$|^COU18|^COU21|^CO60|^CO[M|W]$|^W1U21|^W160|^W1[M|W]$', '1', TGT_IND_6_small10, 40, TGT_IND_6_small10, 40);
            ...
            CreateTargetFace($TourId, 6, '~Default', 'REG-^TU21|^T60|^T[M|W]$', '1', TGT_IND_1_big10, 40, TGT_IND_1_big10, 40);
    ...
    case 7:
        if($SubRule==1) {
            CreateTargetFace($TourId, 1, '~Default', 'REG-^RU18|^RU21|^R60|^R[M|W]$|^ROU18|^ROU21|^RO60|^RO[M|W]$', '1', TGT_IND_6_big10, 60, TGT_IND_6_big10, 60);
            CreateTargetFace($TourId, 2, '~DefaultCO', 'REG-^CU18|^CU21|^C60|^C[M|W]$|^COU18|^COU21|^CO60|^CO[M|W]$|^W1U21|^W160|^W1[M|W]$', '1', TGT_IND_6_small10, 60, TGT_IND_6_small10, 60);
    ...
    case 37:
        if ($SubRule==1) {
            ...
            CreateTargetFace($TourId, 2, '~DefaultCO', 'REG-^CU18|^CU21|^C60|^C[M|W]$', '1', TGT_OUT_5_big10, 80, TGT_OUT_5_big10, 80,TGT_OUT_5_big10, 80, TGT_OUT_5_big10, 80);
            CreateTargetFace($TourId, 3, '~DefaultCO', 'REG-^COU18|^COU21|^CO60|^CO[M|W]$', '1', TGT_OUT_5_big10, 80, TGT_OUT_5_big10, 80,TGT_OUT_5_big10, 80, TGT_OUT_5_big10, 80);
            CreateTargetFace($TourId, 4, '~Default', 'REG-^W1U18|^W1U21|^W160|^W1[M|W]$|^CU15|^COU15', '1', TGT_OUT_FULL, 80, TGT_OUT_FULL, 80,TGT_OUT_FULL, 80, TGT_OUT_FULL, 80);
        } else {
