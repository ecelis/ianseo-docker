 ...
 * Estende Obj_Rank
 */
	class Obj_Rank_Robin_calc extends Obj_Rank_Robin
	{
	/**
	 * calculate().
	 ...
	 */
		public function calculate() {
			...
			$q="SELECT
					...
					IF(EvFinalFirstPhase=0,999999,coalesce(RrLevGroups*RrLevGroupArchers, IF(EvElimType=0, EvNumQualified ,IF(EvElim1=0,EvElim2,EvElim1)))) as QualifiedNo, EvFirstQualified
				FROM Events
				...
				INNER JOIN Qualifications ON IndId=QuId
				left join RoundRobinLevel on RrLevTournament=EvTournament and RrLevTeam=EvTeamEvent and RrLevEvent=EvCode and RrLevLevel=1
				WHERE
