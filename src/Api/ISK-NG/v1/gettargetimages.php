...
$q=safe_r_sql("select ToCode, ToId=IskDvTournament as InTournament, IF(ToNameShort!='', ToNameShort, ToName) as TournamentName, IskDvGroup, IskDvDevice, IskDvTarget, IskDvSetup, IskDvSetupConfirmed, IskDvAppVersion
	FROM IskDevices
...
if(safe_num_rows($q) == 0) {
    ...
    $res = getTargetFaces($r, $req->imgCodes);
